...
<body>
	<table class="table" style="width:100%">
		<tbody>
			...
			<tr>
				<td colspan="4">
					Berikut data pemohon uji laboratorium laboratorium;
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4">
					Telah telah dilaksana pengujian di laboratorium. Laporan hasil kegiatan sudah divalidasi oleh kasublab.
				</td>
			</tr>
			<tr>
				Salam Hormat, <br>
