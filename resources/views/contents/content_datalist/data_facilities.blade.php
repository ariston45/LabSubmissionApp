...
<ol class="breadcrumb">
	...
	<li class="active">Fasilitas Laboratorium</a></li>
</ol>
@endsection
@section('content')
<div class="col-md-12">
...
{{-- js to variables --}}
<script>
	var tabel_technician = $('#tabel-failitas').DataTable({
		processing: true,
		serverSide: true,
		responsive: true,
		lengthChange: true,
		...
		ajax: {
			"url" : "{!! route('source-datatables-fasilitas') !!}",
			"type" : "POST",
			"data" :{
