...
-- ----------------------------
-- Table structure for lab_petitions
-- ----------------------------
DROP TABLE IF EXISTS `lab_petitions`;
CREATE TABLE `lab_petitions`  (
  `ls_id` int(11) NOT NULL,
  `ls_user_app` int(11) NULL DEFAULT NULL,
  `ls_user_acc_1` int(11) NULL DEFAULT NULL,
  `ls_user_acc_2` int(11) NULL DEFAULT NULL,
  `ls_time_start` datetime NULL DEFAULT NULL,
  `ls_time_end` datetime NULL DEFAULT NULL,
  `ls_lab_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `created_at` datetime NULL DEFAULT current_timestamp(),
  `updated_at` datetime NULL DEFAULT current_timestamp() ON UPDATE CURRENT_TIMESTAMP,
  `lab_action` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `lab_title` varchar(600) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`ls_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_petitions
-- ----------------------------
...
CREATE TABLE `lab_schedules`  (
  ...
  `lbs_sch_describe` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `lbs_lab_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `lbs_time_start` datetime NULL DEFAULT NULL,
  `lbs_time_end` datetime NULL DEFAULT NULL,
  `updated_at` datetime NULL DEFAULT curdate() ON UPDATE CURRENT_TIMESTAMP,
  `created_at` datetime NULL DEFAULT current_timestamp(),
  `lbs_sch_type` enum('fixed','interim') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'fixed',
  `lbs_creator` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `lab_submissions`  (
  `lsb_id` int(11) NULL DEFAULT NULL,
  `lsb_title` int(11) NULL DEFAULT NULL,
  `lsb_activity` int(11) NULL DEFAULT NULL,
  `lsb_lab_id` int(11) NULL DEFAULT NULL,
  `lsb_user_id` int(11) NULL DEFAULT NULL,
  `lsb_date_start` date NULL DEFAULT NULL,
  `lsb_date_end` date NULL DEFAULT NULL,
  `lsb_acc_1` date NULL DEFAULT NULL,
  `lsb_acc_2` date NULL DEFAULT NULL,
...
INSERT INTO `menus` VALUES (3, 'ADMIN_SYSTEM', 0, 'ar_settings2.svg', 'Jadwal Lab', 'jadwal_lab', '2024-01-16 16:52:36', '2023-03-28 09:10:32');
INSERT INTO `menus` VALUES (4, 'ADMIN_SYSTEM', 0, 'ar_settings2.svg', 'Pengaturan', 'setting', '2024-01-16 16:52:33', '2014-08-14 01:22:17');
INSERT INTO `menus` VALUES (5, 'ADMIN_SYSTEM', 4, 'ar_items.svg', 'User', 'setting/user', '2024-01-16 16:53:14', '2016-12-08 10:54:08');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 144, 'Agus Salim', 'agus123', 'ADMIN_SYSTEM', '$2y$10$HS8EWaWAgNiho1AyetSIGeWKqQE63FrInMbc859BsAQwGJ4oKwqpy', 'agus@webmaster.com', '2022-12-01 15:03:18', NULL, NULL, NULL, NULL, '2022-12-01 15:04:29', '2024-01-25 13:50:18', NULL);
INSERT INTO `users` VALUES (2, 122, 'aldi taher', 'aldi', 'ADMIN_MASTER', '$2y$10$HS8EWaWAgNiho1AyetSIGeWKqQE63FrInMbc859BsAQwGJ4oKwqpy', 'aldi@gmail.com', NULL, NULL, NULL, NULL, NULL, '2022-12-23 15:33:58', '2024-01-25 15:02:51', NULL);
INSERT INTO `users` VALUES (3, 3537, 'Aliefman Hakim', NULL, 'STUDENT', '$2y$10$GXRXkIOT30U9qGQXGwm08ePkDfsv/E.CHPDg9dMqNXu90jMo0JOfG', 'splashtrick@gmail.com', NULL, NULL, NULL, NULL, NULL, '2024-01-25 15:25:02', NULL, NULL);
