...
<div class="col-md-12">
  <div class="box box-primary">
    ...
    <form class="form-horizontal" action="{{ route('update-data-user') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
      @csrf
      <div class="box-body">
        {{-- !! --}}
        ...
        <div class="form-group has-feedback {{ $errors->has('inp_name') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-12 col-md-9">
            <input type="hidden" id="inp-id" class="form-control" name="id" value="{{ $data_user->id }}" placeholder="Input nama.." autocomplete="new-password">
        ...
        <div class="form-group has-feedback {{ $errors->has('inp_no_id') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-12 col-md-9">
            <input type="text" id="inp-no-id" class="form-control" name="inp_no_id" value="{{ $data_user->no_id }}" placeholder="Input nomor id.." autocomplete="new-password">
        ...
        <div class="form-group has-feedback {{ $errors->has('inp_email') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-12 col-md-9">
            <input type="text" id="inp-email" class="form-control" name="inp_email" value="{{ $data_user->email }}" placeholder="Input email.." autocomplete="new-password">
        ...
        <div class="form-group has-feedback {{ $errors->has('inp_institusi') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-12 col-md-9">
            <input type="text" id="inp-institusi" class="form-control" name="inp_institusi" value="{{ $data_user->usd_universitas }}" placeholder="Input Universitas / Institusi.." autocomplete="new-password">
