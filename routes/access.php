...
Route::group(['middleware' => ['auth']], function () {
	Route::prefix('datasource')->group(function () {
		...
		Route::post('all-lab', [DataController::class, 'sourceDataAllLab'])->name('source-data-all-lab');
	...
	Route::prefix('download')->group(function () {
		...
		Route::get('laporan/{filename}', [DataController::class, 'downloadLaporanKegiatan'])->name('download_laporan');
	});
	/*************************************************************************************************************************************************/
	Route::get('beranda', [HomeController::class, 'HomeSystem']);
	/*************************************************************************************************************************************************/
	Route::prefix('pengajuan')->group(function () {
		...
		Route::get('form-laporan', [PengajuanController::class, 'formLaporan']);
		#action
	...
	Route::prefix('pengaturan')->group(function () {
		...
		Route::get('form-update-user/{id}', [PengaturanController::class, 'formUpdateUser']);
		# action
	...
	Route::prefix('notif')->group(function () {
		Route::get('send_email',function(){
			...
			// Mail::to('support1@trustunified.com')->send(new NotifMail($data));
		});
	});
