		...
		<div class="box-header with-border">
			...
			<div class="pull-right">
				...
				<a href="{{ url('pengajuan') }}">
					<button class="btn btn-flat btn-xs btn-danger"><i class="ri-close-circle-fill" style="margin-right: 4px;"></i>Tutup</button>
				</a>
				@endif
			</div>
		</div>
...
<script>
	$(document).ready(function (){
		tabel_siswa = $('#tabel_pengajuan').DataTable({
			...
			lengthChange: true,
			ajax: {
				"url" : "{!! route('source-datatables-pengajuan-archieve') !!}",
				"type" : "POST",
			},
			columns: [
